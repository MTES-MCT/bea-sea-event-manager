...
def test_retrieve_sea_event_by_uuid(
    ...
    expected_response = {
        ...
        "directive_2009_18": sea_event_to_retrieve.directive_2009_18,
        ...
        "occurrenceSeaArea": sea_event_to_retrieve.occurrence_sea_area,
        "shipName": sea_event_to_retrieve.ship_name,
        "IMO": sea_event_to_retrieve.imo,
        "callSign": sea_event_to_retrieve.call_sign,
        "flagState": sea_event_to_retrieve.flag_state,
        ...
        "occurrenceNationalId": sea_event_to_retrieve.occurrence_national_id,
