    ...
    for dataset_name in dataset_sea_events_as_dict:
        dataset_sea_events_return[dataset_name] = [
            SeaEvent(
                ...
                CrossEntity=sea_event_dict["CrossEntity"],
                sitrepNumber=sea_event_dict["sitrepNumber"],
                region=sea_event_dict["region"],
                shipType=sea_event_dict["shipType"],
                imoNumber=sea_event_dict["imoNumber"],
                immatNumber=sea_event_dict["immatNumber"],
                lht=sea_event_dict["lht"],
                casualtyNumber=sea_event_dict["casualtyNumber"],
                missingNumber=sea_event_dict["missingNumber"],
                injuredNumber=sea_event_dict["injuredNumber"],
            )
